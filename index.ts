...
process.env.INIT_APPS_TO_ENABLE ??= "app-adminizer;app-mcp;app-agentiz;app-agentiz-gitlab-integration;app-agentiz-github-integration;app-agentiz-mobile-api";
